...
In the following chapters we will discuss vulnerabilities in Docker them (\autoref{chapter:vulnerabilities}) and how to identify them (\autoref{chapter:pentesting}). We will do this by using the attacker models of this chapter.
