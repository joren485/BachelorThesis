...
Besides the protection mechanisms on the host, there are also protection mechanisms in the Docker images. The most important protection mechanism that Docker image creators can implement is not running processes inside a container as \lstinline{root}.
